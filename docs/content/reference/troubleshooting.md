...
Most of these come down to network reality or how qqmusic-cli serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

qqmusic-cli rate-limits like any public site. qqmusic already paces
...
Where a surface is gated, qqmusic reads a cookie or token you supply
...
`qqmusic`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what qqmusic actually did
